...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<br><div class='box paperTexture'><h2>"+title+"</h2><hr><img id='"+id+"' onclick='playVideo(test)' src='"+pic + id+"/0.jpg' alt='Error: video could not load'></img><br><br></div>");
}
