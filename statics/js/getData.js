...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<br><div class='box paperTexture'><h2>"+title+"</h2><hr><div><img id='"+id+"' class='videoBg' width='560' height='315' onclick='playVideo(id)' src='"+pic + id+"/0.jpg' alt='Error: video could not load'></img><img src='' alt='Error' class='text-center videoFg'></img</div><br><br></div>");
}
