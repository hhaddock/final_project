...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<div class='shadowBlack paperTexture'><h2>"+title+"</h2><hr><iframe width='560' height='315' src='"+vid + id+"' frameborder='0' allowfullscreen></iframe><br><br></div>");
}
