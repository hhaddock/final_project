...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<br><div class='box paperTexture'><h2>"+title+"</h2><hr><img id='"+id+"' src='"+pic + id+"/0.jpg' alt='Error: video could not load' onclick='playVideo("+id+")'></img><br><br></div>");
}
