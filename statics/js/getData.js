...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<br><div class='box paperTexture'><h2>"+title+"</h2><hr><div class='text-center'><img id='"+id+"' class='videoBg' width='560' height='315' onclick='playVideo(id)' src='"+pic + id+"/0.jpg' alt='Error: video could not load'></img><img src='../assets/playButton.png' alt='Error' width='50px' height='35px' class='text-center videoFg'></img</div><br><br></div>");
}
