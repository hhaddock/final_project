...
function formatVideos(title, id){
  ...
  $('#videoDiv').append("<div class='text-center changeWidth paperTexture'><h2>"+title+"</h2><iframe width='560' height='315' src='"+vid + id+"' frameborder='0' allowfullscreen></iframe></div>");
}
